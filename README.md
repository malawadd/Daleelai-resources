...
هذا هو مستودع الموارد الخاص بـ موقع دليل.
...
- أي مساهمة جديدة تمر عبر مراجعة ثم تظهر داخل موقع دليل بعد النشر.
...
```bash
git clone https://github.com/malawadd/Daleelai-resources.git
cd Daleelai-resources
```
...
أما الملفات داخل `templates/` فهي للقراءة والنسخ فقط.
